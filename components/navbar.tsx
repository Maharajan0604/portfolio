...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* ── Full-width nav bar: logo LEFT · links CENTRE · resume+burger RIGHT ── */}
        <nav
          className={cn(
            "flex items-center justify-between px-4 py-2.5 rounded-2xl transition-all duration-500",
            scrolled
              ? "bg-[oklch(0.09_0.006_240/0.90)] border border-[oklch(0.80_0.15_200/0.12)] shadow-[0_8px_32px_oklch(0_0_0/0.5)] backdrop-blur-xl"
        ...
        >
          ...
          <button
            ...
            className="group relative flex-shrink-0 flex items-center gap-1.5 px-2 py-1"
          >
            <span className="font-mono text-[11px] tracking-widest text-[oklch(0.80_0.15_200/0.50)] group-hover:text-[oklch(0.80_0.15_200/0.90)] transition-colors duration-300">[</span>
            <span className="font-display text-sm font-bold tracking-[0.20em] uppercase text-[oklch(0.92_0.08_200)] group-hover:text-white transition-colors duration-300">MK</span>
            <span className="font-mono text-[11px] tracking-widest text-[oklch(0.80_0.15_200/0.50)] group-hover:text-[oklch(0.80_0.15_200/0.90)] transition-colors duration-300">]</span>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center w-9 h-9 rounded-xl transition-all duration-300 text-[oklch(0.65_0.015_220)] hover:text-[oklch(0.90_0.005_220)] border border-[oklch(0.80_0.15_200/0.15)] hover:border-[oklch(0.80_0.15_200/0.35)] hover:bg-[oklch(0.80_0.15_200/0.06)]"
      ...
      <motion.div
        ...
        className="fixed top-[4.5rem] left-4 right-4 z-40 md:hidden rounded-2xl p-5 bg-[oklch(0.09_0.006_240/0.97)] border border-[oklch(0.80_0.15_200/0.12)] shadow-[0_16px_48px_oklch(0_0_0/0.6)] backdrop-blur-2xl"
      >
        {/* Terminal title bar */}
        <div className="flex items-center gap-1.5 mb-4 pb-3 border-b border-[oklch(0.80_0.15_200/0.08)]">
          ...
          <span className="ml-2 font-mono text-[9px] tracking-widest text-[oklch(0.80_0.15_200/0.35)] uppercase">navigation</span>
        </div>
        ...
        <div className="flex flex-col gap-1">
          {navItems.map((item, i) => {
            ...
            return (
              ...
              >
                <span className={cn("font-mono text-[10px]", isActive ? "text-[oklch(0.80_0.15_200)]" : "text-[oklch(0.80_0.15_200/0.25)]")}>
                  {isActive ? "▶" : "›"}
                </span>
                {item.name}
              </motion.button>
